...
export function HeroSection() {
  ...
  return (
    <section className="w-full min-h-[75vh] flex items-center py-16 md:py-20">
      ...
      <div className="max-w-10/12 mx-auto w-full px-6 lg:px-10">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-14 md:gap-8 lg:gap-12">
          ...
          <div className="w-full md:w-3/5 text-center md:text-left">
            ...
            <TypingAnimation
              as="h1"
              className="text-5xl md:text-6xl lg:text-7xl font-bold mb-5 text-cyan-500 courgette-regular"
            ...
            {showSubtitle && (
              <motion.h2
                ...
                className="text-2xl md:text-2xl lg:text-3xl font-semibold text-white mb-6 courgette-regular"
              >
            ...
            {showParagraph && (
              <motion.p
                ...
                className="text-lg md:text-xl leading-8 text-gray-400 text-justify aboutParagraph"
              >
