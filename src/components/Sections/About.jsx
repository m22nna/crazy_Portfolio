...
function About() {
  return (
    ...
    >
      ...
      >
        <p className="text-xl md:text-2xl leading-9 md:leading-10 text-gray-400 text-justify">
          I'm a 2026 Computer Science graduate from October 6 University
          and a Front-End Developer specializing in React. I enjoy building
          modern, responsive, and user-friendly web applications with a
          strong focus on clean, maintainable code and great user experience.
          Currently, I'm learning the fundamentals of Node.js to expand my
          full-stack development skills. I'm passionate about continuous
          learning, solving problems, and improving my skills by working on
          real-world projects.
        </p>
      </motion.div>
    </section>
